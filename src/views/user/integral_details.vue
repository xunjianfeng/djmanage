	...
	<div class="index">
		...
		<div class="container">
			<div class="top_tabs">
				...
				<div class="tabs_block" @click="jump_play(1)">用户积分 /</div>
				<div class="tabs_block">积分明细</div>
			</div>
			<div class="play_container">
				<div class="play_head">
					<div class="screen_title">
						<div class="screen_text">积分明细</div>
					</div>
					<!-- 筛选条件 -->
					<div class="screen_condition">
						<div class="scr_left">
							<div class="screen_left">
								<div class="search_span">积分来源：</div>
					...
					<div class="play_form">
						<div class="play_table">
							<div class="table_header">
								...
								<div class="table_head_div">积分来源</div>
								<div class="table_head_div">积分变化前</div>
								<div class="table_head_div">积分变化</div>
								<div class="table_head_div2">积分变化后</div>
								<div class=""></div>
							</div><!-- table_header -->
							<div class="table_body">
								<div class="no_data" v-if="point_list ==''">暂无数据</div>
								<div class="body_row" v-for="(item,index) in point_list" :key="index" v-if="point_list !=''">
									...
									<div class="row_td_block">{{item.pointBefore}}</div>
									<div class="row_td_block">
										<span :class="item.prefix == '+' ?'num_color':'num_color2'">
										{{item.prefix}}
										{{Math.abs(item.pointAmount)}}
										</span> 
									</div>
									<div class="row_td_block2">{{item.pointAfter}}</div>
								</div>
							</div>
						</div>
						<!-- 分页 -->
...
<script>
	...
	import {pointDetail} from '@/api/user.js'
